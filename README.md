...
Angular + Cypress + Karma tests - Report

## KARMA Report

![Karma Result - 1](./karma-result-1.png)
![Karma Result - 2](./karma-result-2.png)


## Cypress Report

![Cypress Result - 1](./cypress-result-1.png)
![Cypress Result - 2](./cypress-result-2.png)